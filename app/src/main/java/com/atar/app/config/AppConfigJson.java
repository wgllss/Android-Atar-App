...
public class AppConfigJson {
    ...
    private boolean isReplace = true;// 如果apk新发版本 这个配置也新发配置.txt文件，为true: 老版本要替换该配置.txt, false
    // :老版本不替换该.txt
    private String skinVersion;// 皮肤版本
    private String replaceMinVersion;// 替换皮肤的最小版本

    private List<String> all_skins; // 所有种类的皮肤
    private String loadImage_Version;// 开机引导图版本， 更新功能但不用升级apk, 又需要更新引导图 就改成比线上版本号大点，否则可不用配置
    // (改loadImage_Version 必须改versionName版本大点 和 isReplace为true)

...
public class DragSortListView extends ListView {
    ...
    private OnRemoveingListener mOnRemoveingListener;
    private OnRemoveingDoingListener mOnRemoveingDoingListener;
    ...
    public void setRemoveEnabled(boolean removeEnabled) {
        ...
        if (controller != null) {
            controller.setOnRemoveingListener(mOnRemoveingListener);
            controller.setOnRemoveingDoingListener(mOnRemoveingDoingListener);
     ...
     * 监听正不滑动删除
     *
     * @param mOnRemoveingListener
     * @author :Atar
     * @createTime:2014-8-28下午3:27:15
     * @version:1.0.0
     * @modifyTime:
     * @modifyAuthor:
     * @description:
     */
    public void setOnRemoveingListener(OnRemoveingListener mOnRemoveingListener) {
        this.mOnRemoveingListener = mOnRemoveingListener;
        if (controller != null) {
            controller.setOnRemoveingListener(mOnRemoveingListener);
            controller.setOnRemoveingDoingListener(mOnRemoveingDoingListener);
            controller.setRemoveEnabled(removeEnabled);
    ...
    public void setOnRemoveingDoingListener(OnRemoveingDoingListener mOnRemoveingDoingListener) {
        this.mOnRemoveingDoingListener = mOnRemoveingDoingListener;
        if (controller != null) {
            controller.setOnRemoveingListener(mOnRemoveingListener);
            controller.setOnRemoveingDoingListener(mOnRemoveingDoingListener);
            controller.setRemoveEnabled(removeEnabled);
    ...
    public DragSortListView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (useDefault) {
                ...
                controller = new DragSortController(this, dragHandleId, dragInitMode, removeMode, clickRemoveId, flingHandleId);

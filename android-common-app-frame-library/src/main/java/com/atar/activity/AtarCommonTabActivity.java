...
public abstract class AtarCommonTabActivity<V extends ViewGroup> extends AtarCommonActivity implements OnTabInterface<V, CommonActivity> {
     ...
     * @description:
     */
    public void setTabUI(ViewPager mViewPager, FrameLayout frameMove, LinearLayout mLinearLayout, View viewMove) {
        if (mImplOnTabInterface == null) {

 ...
 * 
 * @author :Atar
 * @createTime:2015-6-18上午11:30:32
 * @version:1.0.0
 * @modifyTime:
 * @modifyAuthor:
 * @description:
...
public class PullToRefreshDragSortListView extends PullToRefreshAdapterViewBase<DragSortListView> {
	...
	public PullToRefreshDragSortListView(Context context, Mode mode) {
		super(context, mode);
	}

	public PullToRefreshDragSortListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public PullToRefreshDragSortListView(Context context, com.handmark.pulltorefresh.library.PullToRefreshBase.Mode mode, AnimationStyle animStyle) {
	...
	protected DragSortListView createListView(Context context, AttributeSet attrs) {
	...
	@Override
	protected DragSortListView createRefreshableView(Context context, AttributeSet attrs) {
		DragSortListView lv = createListView(context, attrs);
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
			...
			OverscrollHelper.overScrollBy(PullToRefreshDragSortListView.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);

			return returnValue;
		}
	}

	protected class InternalListView extends DragSortListView implements EmptyViewMethodAccessor {
		...
		public void setEmptyView(View emptyView) {
			PullToRefreshDragSortListView.this.setEmptyView(emptyView);
		}

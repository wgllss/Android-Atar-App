...
//		void clickDownload(View v);
//
//		void clickPause(View v);
//
//		void clickResume(View v);
//
//		void clickFinish(View v);
//	}
//
...
//				}
//				if (getState() == NORMAL) {
//					mOnDownLoadClickListener.clickDownload(v);
//					setState(DOWNLOADING);
//					setProgressText(0);
//				} else if (getState() == DOWNLOADING) {
//					if (mEnablePause) {
//						mOnDownLoadClickListener.clickPause(v);
//						setState(PAUSE);
//					}
//				} else if (getState() == PAUSE) {
//					mOnDownLoadClickListener.clickResume(v);
//					setState(DOWNLOADING);
//					setProgressText((int) mProgress);
//				} else if (getState() == FINISH) {
//					mOnDownLoadClickListener.clickFinish(v);
//				}
//			}
//		});
//	}
...
//	}
//
//	public void setTextCoverColor(int mTextCoverColor) {
...
//	}
//
//	public void setBackgroundSecondColor(int mBackgroundSecondColor) {
